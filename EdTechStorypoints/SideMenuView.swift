...
let sidebar = [
    ...
    sideBar (icon: "chart.bar.xaxis", title: "Activity", tab: .Activity, index: 1),
...
struct TabviewV: View {
    ...
    var body: some View {
        TabView(selection: $selctedIndex) {
            imageview(image: "AdBanner1")
                .tag(1)
            imageview(image: "AdBanner2")
                .tag(2)
            imageview(image: "AdBanner3")
                .tag(3)
            imageview(image: "AdBanner4")
                .tag(4)
            imageview(image: "AdBanner5")
                .tag(5)
        }
