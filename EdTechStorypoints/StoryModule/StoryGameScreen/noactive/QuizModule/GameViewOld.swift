...
//                    switch currentModule.moduleType {
//                    case .quiz:
//                        let isCorrect = viewModel.checkAnswer(viewModel.selectedAnswer)
//                        if isCorrect {
...
//                        
//                    case .findPair:
//                        let isCorrect = viewModel.checkAnswer(selectedPairs)
//                        if isCorrect {
//                            viewModel.showCorrectSheet = true
//                        } else {
//                            viewModel.showIncorrectSheet = true
...
//                        
//                    case .chronology:
//                        let isCorrect = viewModel.checkOrder(eventList: viewModel.eventList)
//                        if isCorrect {
//                            viewModel.showCorrectSheet = true
//                        } else {
//                            viewModel.showIncorrectSheet = true
